...
const GymClients = () => {
  ...
  return (
    <>
      {images && (
        <div className="max-w-2xl sm:px-0 mt-5 md:max-w-7xl">
          ...
          <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
            {images.map((client) => (
              <div key={client.id} className="group relative">
                <div className="aspect-h-1 aspect-w-1 w-full overflow-hidden shadow-lg rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-75 lg:h-80">
                  <img
                    src={client.url}
                    alt={client.url}
                    loading="lazy"
